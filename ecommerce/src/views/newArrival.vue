            ...
            <div class="bg-gray-13 bg-md-transparent">
                <div class="container">
                    <div class="my-md-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                ...
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">Шинэ бүтээгдэхүүн</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div v-else align="center">
                        <h3 class="font-weight-light mb-5 mt-5">ҮР ДҮН ОЛДСОНГҮЙ</h3>
                    </div>
                </div>
            </div>
        </main>
...
export default {
    ...
    methods: {
        ...
        getProduct() {
                ...
                this.$axios({
                    method: 'post',
                    url: rts.$appUrl +'/api/product/new-arrival',
                    headers: {},
                    data: {
