                    ...
                    <div class="my-md-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                ...
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><router-link :to="'/category/'+category.name.id">{{category.name.category_name}}</router-link></li>
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{category.name.sub_category_name}}</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="container">
                            ...
                            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                                <div class="mb-6">
                                    ...
                                    <div class="border-bottom pb-1 mb-1">
                                        ...
                                        <!-- <div v-for="(item, index) in category.brand.slice(0,5)" :key="index" class="form-group d-flex align-items-center justify-content-between mb-2 pb-1" style="position: relative;">
                                    ...
                                    <div class="border-bottom pb-1 mb-1">
                                        <div style="position: relative;">
                                            ...
                                            <a class="link link-collapse small font-size-13 text-gray-27 d-inline-flex" v-if="category.color.length > 5" data-toggle="collapse" href="#collapseColor" role="button" aria-expanded="false" aria-controls="collapseColor" style="position: absolute; right: 0;">
                                                <span class="link-collapse__default"> <i class="el-icon-arrow-down"></i></span>
                                                <span class="link-collapse__active"> <i class="el-icon-arrow-up"></i></span>
                                            </a>
                                            <!-- End View More - Collapse -->
                                    ...
                                    <div class="range-slider">
                                       ...
                                       <div class="block">
                                        ...
                                        <!-- End Range Slider -->
                                        <div class="mt-1 text-gray-111 d-flex mb-1">
                        ...
                        <div class="js-scrollbar u-sidebar__body">
                            <div class="u-sidebar__content u-header-sidebar__content px-4">
                                <div class="mb-6">
                                    ...
                                    <div class="border-bottom pb-1 mb-1" v-for="(main, index) in spec.list" :key="index">
                                        <div style="position: relative;">
                                            <span class="font-size-14 mb-3 font-weight-bold">{{main.replace('_', ' ')}}</span>

                                            <a class="link link-collapse small font-size-13 text-gray-27 d-inline-flex" v-if="spec.parametrs[main].length > 0" data-toggle="collapse" :href="'#main-collapseSpec' + main" role="button" aria-expanded="false" aria-controls="collapseBrand" style="position: absolute; right: 0;">
                                                <span class="link-collapse__default"> <i class="el-icon-arrow-down"></i></span>
                                                <span class="link-collapse__active"> <i class="el-icon-arrow-up"></i></span>
                                            </a>
                                        </div>
                                        ...
                                        <!-- <div v-for="(item, index) in spec.parametrs[main].slice(0,2)" :key="index" class="form-group d-flex align-items-center justify-content-between mb-2 pb-1" style="position: relative;">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" :id="'main-nav-spec'+item.name" :ref="'main-nav-spec'+item.name">
                                                <label class="custom-control-label" :for="'main-nav-spec'+item.name">{{item.name}}</label>
                                            </div>
                                            <span class="text-gray-25 font-size-12 font-weight-normal" style="position: absolute; right: 0;">{{item.total}}</span>
                                        </div> -->

                                        <div v-if="spec.parametrs[main].length > 0" class="collapse" :id="'main-collapseSpec' + main">
                                            <div v-for="(item, index) in spec.parametrs[main].slice(0,spec.parametrs[main].length)" :key="index" class="form-group d-flex align-items-center justify-content-between mb-1 pb-0" style="position: relative;">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" @click="changeBrand(item.id)" :id="'main-nav-spec'+item.name" :ref="'main-nav-spec'+item.name">
                                                    <label class="custom-control-label" :for="'main-nav-spec'+item.name">{{item.name}}</label>
                                                </div>
                                                <span class="text-gray-25 font-size-12 font-weight-normal" style="position: absolute; right: 0;">{{item.total}}</span>
                                            </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li v-for="(item, index) in recently.slice(0,5)" :key="index" class="mb-1">
                                            <div class="row">
                                                <div class="col-auto">
                                                    <router-link :to="'/single-product/'+item.id" class="d-block width-75">
                                                        <img class="img-fluid" :src="$appUrl+'/images/product/'+item.image" :alt="item.name">
...
export default {
    ...
    methods: {
        ...
        getProducts() {
            ...
            this.$axios({
                method: 'post',
                url: rts.$appUrl +'/api/product/sub-category-product',
                headers: {},
                data: {
                    id: this.category.id,
                ...
                if(data.data.result == 'success') {
                    ...
                    document.querySelector('head title').textContent = data.data.category.sub_category_name;
                } else {
