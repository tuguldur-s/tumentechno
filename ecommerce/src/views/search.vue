            ...
            <div class="bg-gray-13 bg-md-transparent">
                <div class="container">
                    <div class="my-md-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                                ...
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active">Бүтээгдэхүүн хайлт</li>
                                <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1 active" aria-current="page">{{this.sValue}}</li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="d-none d-xl-block col-xl-3 col-wd-2gdot5">
                                <div class="mb-6">
                                    ...
                                    <div class="border-bottom pb-1 mb-1">
                                        <div style="position: relative; cursor: pointer;" data-toggle="collapse" href="#collapseSub">
                                        ...
                                        <div v-for="(item, index) in category.sub" :key="index" class="form-group d-flex align-items-center justify-content-between mb-2 pb-1" style="position: relative;">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" @click="changeSub(item.id)" :id="'nav-sub'+item.sub_category_name" :ref="'nav-sub'+item.id">
                                                <label class="custom-control-label" :for="'nav-sub'+item.sub_category_name">{{item.sub_category_name}}</label>
                                            </div>
                                    ...
                                    <div class="border-bottom pb-1 mb-1">
                                        <div style="position: relative; cursor: pointer;" data-toggle="collapse" href="#collapseBrand">
                                    ...
                                    <div class="border-bottom pb-1 mb-1">
                                        <div style="position: relative; cursor: pointer;" data-toggle="collapse" href="#collapseColor">
                                        ...
                                        <div v-if="category.color.length > 0" class="collapse" id="collapseColor">
                                            <div v-for="(item, index) in category.color.slice(5, category.color.length)" :key="index" class="form-group d-flex align-items-center justify-content-between mb-1 pb-0" style="position: relative;">
                                                <div class="custom-control custom-checkbox">
                    ...
                    <div v-else align="center">
                        <h3 class="font-weight-light mb-5 mt-5">{{valuetext}}</h3>
                    </div>
                </div>
            </div>
        </main>
...
export default {
    ...
    mounted() {
        this.$emit('getJquery');
        this.sValue = this.$route.query.p;
        this.getProduct();
    },
    beforeRouteUpdate (to, from, next) {
        this.sValue = to.query.p;
        this.page.current = 1;
        this.product = [];
    ...
    methods: {
        ...
        getProduct() {
            ...
            this.valuetext = 'ТҮР ХҮЛЭЭНЭ ҮҮ';
            let search = this.sValue;
            if(search != null && search != undefined && search != '') {
                var rts = this;
                this.$axios({
                    method: 'post',
                    url: rts.$appUrl +'/api/product/search',
                    headers: {},
                    data: {
                        search: search,
